...
PROVIDERS = {
    "local_gemini": {
        ...
        "note": "本地 gcli2api 反代生图通道，支持 1:4 / 1:8 长图",
    },
    "suxi": {
        "name": "SuXi.ai",
...
# ============================================================
# 从本地钥匙文件加载 api_key（image_api_keys.local.json 不进 git，模板见 .example.json）
# ============================================================
def _load_local_keys():
    ...
    try:
        ...
        print(f"[warn] 读取 image_api_keys.local.json 失败: {e}")
        return {}
